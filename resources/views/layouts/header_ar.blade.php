...
<html class="no-js" lang="ar" dir="rtl"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="" />
        <link rel="prefetch" href="dist/images/1.jpg">
        <link rel="stylesheet" type="text/css" href="dist/styles/fonts.css" media="none" onload="this.media='all';"> 
        <link rel="stylesheet" href="dist/styles/main.min.css">
        <link rel="stylesheet" href="dist/styles/main_ar.css?100">
        <link rel="stylesheet" href="dist/styles/developer.css?100">
                  ...
                  <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand logoChangerWrap">
                          <a href="index.php" class="navbar-brand-img active">
                              <img title="Youth 101 dubai" src="dist/images/youth-101-logo.svg">
                          </a>
                          <a target="_blank" href="http://youth.gov.ae/" class="navbar-brand-img logo-medium">
                              <!-- <img title="web design dubai" src="dist/images/youth.gov-logo-en.png"> -->
                              <img title="Youth 101 dubai" src="dist/images/logo_uae-en.svg">
                          </a>
                        </div>
                        <div class="secondaryLogo logoChangerWrap">
                          <a href="index.php" class="secondaryLogoImg active">
                              <img alt="logo" title="Youth 101 dubai" src="dist/images/youth-101-logo.svg">
                          </a>
                          <a href="index.php" class="secondaryLogoImg">
                              <!-- <img alt="logo" title="web design dubai" src="dist/images/youth.gov-logo-en.png"> -->
                              <img alt="logo" title="Youth 101 dubai" src="dist/images/logo_uae-en.svg">
                          </a>
                        </div>
                    ...
                    <div id="navbar-collapse-1" class="navbar-collapse collapse">
                      <ul class="nav navbar-nav mainNav">
                        ...
                        <!-- <li class="active-main-menu"><a class="scroll" data-href="#home"  href="#home">Home</a></li> -->
                        <li class="active-main-menu"><a class="scroll" data-href="#content"  href="#content">الرئيسية</a></li>
                        <li><a class="scroll"  href="#about" data-href="#about">عن المبادرة</a></li>
                        <li><a class="scroll"  href="#digital101" data-href="#digital101">أساسيات رقمية</a></li>
                        <li><a class="scroll" href="#upcomingSessions" data-href="#upcomingSessions">الجلسات القادمة </a></li>
                        <li><a class="langSwitch" href="index.php">English</a></li>
